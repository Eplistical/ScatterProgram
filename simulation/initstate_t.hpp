...
namespace scatter{
	class initstate_t{
		private:
			...
			size_t _elestate;
			double _temp;
			std::vector<scatter::mode::initmode> _mode;
		...
		public:
			...
			// setter
			void set_mode(const std::vector<scatter::mode::initmode>& mode);
			void set_mode(size_t d, const scatter::mode::initmode& mode);
			...
			mode::initmode get_mode(size_t d) const;
