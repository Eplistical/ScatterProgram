...
static std::vector<double> RK4_f(const particle_t& ptcl, enumspace::dynamics_mode_enum mode){
...
void scatter::simulation::runge_kutta_4th(particle_t& ptcl, enumspace::dynamics_mode_enum mode, forcefunc_t RK4_g){
